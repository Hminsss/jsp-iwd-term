...
<body> 
    ...
    <!-- bradcam_area_end -->
	<div class="container">
		<form name="newFindPetPost" action="./addProtectPet_process.jsp" class="form-horizontal" method = "post" enctype="multipart/form-data">
			<div class="alert alert-danger" role="alert" style ="text-align:center;"><h4 style="margin-top:1%;">기본정보</h4></div>
	
			<div class="form-group row">
			<label class="col-2">구분</label>
			<div class="col">
				<div class="btn-group btn-group-toggle" data-toggle="buttons">
						<label class="btn btn-warning">
							<input type="radio" name="done" id="jb-radio-1" value ="0" checked> 목격
						</label>
						<label class="btn btn-success">
							<input type="radio" name="done" id="jb-radio-2" value = "1"> 보호
						</label>
					</div>
			</div>
			</div>
			<div class="form-group row">
				...
				<div class="col">
					<input type='date' id='catchDate' name="catchDate" class="form-control">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2">지역</label>
				<div class="col">
					<select name="disappearLocation1" class="form-control" onChange="cat1_change(this.value,disappearLocation2)" style ="display: inline;" >
				...
				<div class="col">
					<input type="text" name="disappearLocation3"  class="form-control" placeholder="구체적인 장소를 적어주세요.">
				</div>
			</div>
			<div class="alert alert-danger" role="alert" style ="text-align:center;"><h4 style="margin-top:1%;">동 물 정 보</h4></div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col">
					<label class="badge">
						<input type="radio" name="gender" value="성별 미확인" checked> 성별 미확인
					</label>
					<label class="badge">
			...
			<div class="form-group row">
				...
				<div class="col">
					<input type="text" name="color" class="form-control" placeholder="무늬나 털색을 적어주세요.">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2">특징</label>
				<div class="col">
					<input type="text" name="catr" class="form-control" placeholder="눈에 띄는 특징을 적어주세요.">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col">
					<textarea name="description" cols="50" rows="2" class="form-control" placeholder="상세한 내용을 작성해주세요."></textarea>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2">사진</label>
				<div class="col">
					<input type="file" name="fileName" class="form-control" placeholder="눈에 띄는 특징을 적어주세요.">
				</div>
			</div>

			<div style="text-align:center;">
				<button type = "submit" class="genric-btn primary-border circle" style="margin-top:3%; margin-bottom:5%;text-align:center;">작성하기</button>
			</div>
		</form>
	</div>
    ...
    <script>
   	 ...
   	 <script>
  		document.getElementById('catchDate').value = new Date().toISOString().substring(0, 10);;
	</script>
